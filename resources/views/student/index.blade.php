        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-10 text-center">
              <h1>The <strong>Hub</strong> Of <strong>Learning</strong></h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-4">
              <div class="box small h-100">
                <div class="d-flex align-items-center mb-2">
                  <div class="img"><img src="{{asset('student/images/img_2.jpg')}}" class="img-fluid" alt="Image"></div>
                  <div class="text">
                    <a href="#" class="category">Tutorial</a>
                    <h3><a href="#">Learning React Native</a></h3>
                  </div>
                ...
                <div class="d-flex align-items-center mb-2">
                  <div class="img"><img src="{{asset('student/images/img_3.jpg')}}" class="img-fluid" alt="Image"></div>
                  <div class="text">
                    <a href="#" class="category">Tutorial</a>
                    <h3><a href="#">Learning React Native</a></h3>
                  </div>
                ...
                <div class="d-flex align-items-center">
                  <div class="img"><img src="{{asset('student/images/img_4.jpg')}}" class="img-fluid" alt="Image"></div>
                  <div class="text">
                    <a href="#" class="category">Tutorial</a>
                    <h3><a href="#">Learning React Native</a></h3>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="box-side mb-3">
                <a href="#"><img src="{{asset('student/images/img_1_horizontal.jpg')}}" alt="Image" class="img-fluid"></a>
                <h3><a href="#">Learning React Native</a></h3>
              </div>  
              <div class="box-side mb-3">
                <a href="#"><img src="{{asset('student/images/img_2_horizontal.jpg')}}" alt="Image" class="img-fluid"></a>
                <h3><a href="#">Learning React Native</a></h3>
              </div>  
              <div class="box-side">
                <a href="#"><img src="{{asset('student/images/img_3_horizontal.jpg')}}" alt="Image" class="img-fluid"></a>
                <h3><a href="#">Learning React Native</a></h3>
              </div>  
            </div>
          </div>
